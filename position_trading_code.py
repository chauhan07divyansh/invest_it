...
class EnhancedPositionTradingSystem:
    ...
    def calculate_position_sizes(self, selected_stocks, budget, stock_results):
        """Calculate position sizes based on risk and budget"""
        portfolio = {}
        ...
        for symbol, score in selected_stocks.items():
            ...
            # Adjust weight based on risk metrics
            ...
            risk_adjustment = 1.0 / (1.0 + volatility * 2)  # Reduce weight for high volatility
